function dataPF = fitPSFmodel(data, betaBool)
...
paramsIDmatrix = [1:3; 4:6; 7:9; 10 10 10]';
...
lowerBounds = [reshape(repmat([0.025 -inf guessLimits(1)],[NumCond 1]),[1 NumCond*3]) lapseLimits(1)];
upperBounds = [reshape(repmat([0.225  inf guessLimits(2)],[NumCond 1]),[1 NumCond*3]) lapseLimits(2)];
...
%Throw a warning if the fit did not converge
if ~(exitflag == 1)
