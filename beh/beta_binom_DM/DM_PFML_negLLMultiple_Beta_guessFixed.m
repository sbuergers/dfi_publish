...
function negLL = DM_PFML_negLLMultiple_Beta_guessFixed(ParamsVector, paramsIDmatrix, StimLevels, NumPos, OutOfNum, PF, lapseLimits, betaBool)
...
if (min(params(:,3)) < lapseLimits(1)) || (max(params(:,3)) > lapseLimits(2)) || ...
        (eta >= 1) || (eta < 0) || ...
