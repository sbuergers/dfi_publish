...
% Here nuisance factors are not regressed out before computing fslide.
%
% Parent script(s): 
%
...
%   dfi_source_clusterPerm_dprime_no_regress_freq.m
%   dfi_source_clusterPerm_dprime_no_regress_freq_yesno.m
%   dfi_source_clusterPerm_criterion_no_regress_freq.m
%   dfi_source_clusterPerm_criterion_no_regress_freq_yesno.m
%   
% Children script(s): 
%   None
%
...
for icond = 1:3
    ...
    load(fullfile(main_dir, ...
        'fslide', 'yesno', 'dprime', 'no_regress', ...
...
for icond = 1:3
    ...
    % Load in figure data
    load(fullfile(main_dir, ...
        'fslide', 'lcmv', 'yesno', 'dprime', 'no_regress', ...
...
for icond = 1:3
    ...
    % Load in figure data
    load(fullfile(main_dir, ...
        'fslide', 'lcmv', 'ynt', 'dprime', 'no_regress', ...
        sprintf('figure_data_src_roi_%s.mat', condvect{icond})));
...
saveas(fh1,fullfile(main_dir, ...
    'iAF_within', 'sd_params', 'fslide_dprime_no_regress_svg.svg'))
close all
...
saveas(fh2, fullfile(main_dir, ...
    'iAF_within', 'sd_params', 'fslide_dprime_no_regress_bf_svg.svg'))
...
for icond = 1:3
    ...
    % Load in figure data
    load(fullfile(main_dir, ...
        'fslide', 'yesno', 'criterion', 'no_regress', ...
         sprintf('figure_data_PO4_O2_PO8_%s.mat', condvect{icond})));
...
for icond = 1:3
    ...
    % Load in figure data
    load(fullfile(main_dir, ...
        'fslide', 'lcmv', 'yesno', 'criterion', 'no_regress', ...
        sprintf('figure_data_src_roi_%s.mat', condvect{icond})));
...
for icond = 1:3
    ...
    % Load in figure data
    load(fullfile(main_dir, ...
        'fslide', 'ynt', 'criterion', 'no_regress', ...
        sprintf('figure_data_PO4_O2_PO8_%s.mat', condvect{icond})));
...
for icond = 1:3
    ...
    % Load in figure data
    load(fullfile(main_dir, ...
        'fslide', 'lcmv', 'ynt', 'criterion', 'no_regress', ...
        sprintf('figure_data_src_roi_%s.mat', condvect{icond})));
...
fh.Renderer = 'painters'; 
saveas(fh1,fullfile(main_dir, ...
    'iAF_within', 'sd_params', 'fslide_criterion_no_regress_dfi_bug_fixed.svg'))
close all
...
fh2.Renderer = 'painters'; 
saveas(fh2, fullfile(main_dir, ...
    'iAF_within', 'sd_params', 'fslide_criterion_no_regress_bf_svg.svg'))
