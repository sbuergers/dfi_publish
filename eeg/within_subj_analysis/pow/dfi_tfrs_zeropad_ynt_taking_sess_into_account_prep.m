...
%
% Sibling script(s):
%   dfi_fslide_yn_taking_sessions_into_account_prep.m
%
%
% DETAILS
%
...
for isubj = 1:N 
    ...
    for isess_combi = 1:ncomb
        ...
        s.overlap  = 0.04; %0.01; % slide in 10 ms steps
        s.toi      = [-0.6, 0]; % overall window of interest (though close to 0 data is contaminated by noise)
        s.tfrbsl   = 'no';
