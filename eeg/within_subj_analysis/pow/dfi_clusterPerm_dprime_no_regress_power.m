...
for icond = 1:3
    ...
    mkdir('D:\dfi_experiment_figures\Paper_figures\iAF\power\ynt\dPrime\no_regress');
    save(fullfile('D:\dfi_experiment_figures\Paper_figures\iAF\power\ynt\dPrime\no_regress', ...
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('dPrime_no_regress_power_w_BF_PO4_O2_PO8_%s_%s', condvect{icond}, chan)), '-tiff', '-m2.5')
    close all
