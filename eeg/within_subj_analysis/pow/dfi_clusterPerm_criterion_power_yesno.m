...
load(fullfile(data_dir, 'sdt', 'power', 'sd_params_d_c_yesno.mat'));
...
for icond = 1:3
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('criterion_power_yesno_w_BF_PO4_O2_PO8_%s_%s', condvect{icond}, chan)), '-tiff', '-m2.5')
    close all
