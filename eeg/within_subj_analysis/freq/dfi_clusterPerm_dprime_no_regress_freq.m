...
for icond = 1:3
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('dPrime_noregress_fslide_w_BF_PO4_O2_PO8_%s_%s', condvect{icond}, chan)), '-eps', '-tiff', '-m2.5')
    close all
