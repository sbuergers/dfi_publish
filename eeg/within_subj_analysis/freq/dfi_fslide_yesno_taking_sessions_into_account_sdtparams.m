...
save(data_dir, 'fslide_mat', 'btable', 'channels_of_interest', 'toi', '-v7.3')
...
for isubj = 1:N
    ...
    for isess = 1:length(sessions)
        data_within = fslide_collapsed(btable.sess == isess & ...
