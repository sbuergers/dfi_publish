...
%
% Children script(s): 
%   dfi_fig_eeg2_sdparams_no_regress_freq_bias_dfi_neg.m
%
% Sibling script(s):
...
%     export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, ...
%         sprintf('criterion_no_regress_fslide_yesno_w_BF_PO4_O2_PO8_%s_%s', ...
%         condvect{icond}, chan)), '-eps', '-tiff', '-m2.5')
    close all
