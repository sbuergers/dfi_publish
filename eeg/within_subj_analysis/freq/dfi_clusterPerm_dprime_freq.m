...
%
% Children script(s): 
%   dfi_fig_eeg2_sdparams_freq_bias_dfi_neg.m
%
% Sibling script(s):
...
save_dir = fullfile(fig_dir, 'Paper_figures', 'iAF', 'fslide', 'ynt', 'dPrime');
...
for icond = 1:3
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('dPrime_fslide_w_BF_PO4_O2_PO8_%s_%s', condvect{icond}, chan)), '-eps', '-tiff', '-m2.5')
    close all
