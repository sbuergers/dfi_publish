...
% Ran hi_pow on 18.02.2021, 11:20h
% Ran lo_pow on 18.02.2021, 11:29h
...
for icond = 1:3
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('dPrime_fslide_yesno_w_BF_PO4_O2_PO8_%s_%s_indivSOA', condvect{icond}, chan)), '-eps', '-tiff', '-m2.5')
    close all
