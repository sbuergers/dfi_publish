...
for icond = 1:3
    ...
    mkdir(fullfile('D:\dfi_experiment_figures\Paper_figures\iAF\fslide\yesno\criterion', pow_cond));
    save(fullfile('D:\dfi_experiment_figures\Paper_figures\iAF\fslide\yesno\criterion', pow_cond, ...
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('criterion_fslide_yesno_subjSOAs_PO4_O2_PO8_%s_%s', condvect{icond}, chan)), '-eps', '-tiff', '-m2.5')
    close all
