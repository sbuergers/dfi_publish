...
for icond = 1:3
    ...
    mkdir(fullfile('D:\dfi_experiment_figures\Paper_figures\iAF\fslide\ynt\dPrime', pow_cond))
    save(fullfile('D:\dfi_experiment_figures\Paper_figures\iAF\fslide\ynt\dPrime', pow_cond, ...
