...
load_dir = fullfile(data_dir, 'source_analysis', 'sdt', 'freq_slide', 'no_regress');
fig_dir  = 'dfi_experiment_figures';
save_dir = fullfile(fig_dir, 'Paper_figures', 'iAF', 'fslide', 'lcmv', ...
                    'ynt', 'criterion', 'no_regress');
...
for icond = 1:3
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('criterion_fslide_w_BF_src_roi_%s_%s', condvect{icond}, chan)), '-eps', '-tiff', '-m2.5')
    close all
