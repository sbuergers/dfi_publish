...
save_dir = fullfile(data_dir, 'source_analysis', 'sdt', 'freq_slide', 'no_regress');
...
save(fullfile(data_dir, 'source_analysis', 'fslide_table_yesno.mat'), ...
...
load(fullfile(data_dir, 'source_analysis', 'fslide_table_yesno.mat'));
