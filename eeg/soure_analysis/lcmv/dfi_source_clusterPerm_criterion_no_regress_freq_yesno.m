...
%
% Parent script(s): 
%   dfi_source_fslide_yesno_sdtparams.m
%
% Children script(s): 
%   None
%
...
save_dir = fullfile(fig_dir, 'Paper_figures', 'iAF', 'fslide', ...
                    'lcmv', 'yesno', 'criterion', 'no_regress');
...
for icond = 1:3
    ...
    %export_fig(fh, fullfile(fig_dir, an_fold, foldername, fold_data, task, sprintf('criterion_fslide_yesno_w_BF_src_roi_%s_%s', condvect{icond}, chan)), '-eps', '-tiff', '-m2.5')
    close all
