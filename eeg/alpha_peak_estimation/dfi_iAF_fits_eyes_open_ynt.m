...
if ~exist(fullfile(fig_dir, an_fold, task), 'dir')
    mkdir(fullfile(fig_dir, an_fold, task));
end

fname = 'eyes_open_pkinfo';
save(fullfile(fig_dir, an_fold, task, fname), 'muPaf*', 'muPow*', 'pSpec', 'cmin', 'channel_vect', 'fRange', 'w', 'Fs', 'Fw', 'k');
