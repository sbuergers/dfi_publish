% SB: I simply changed the integral range from 0 to 1 to only include
% positive values in the prior range, negative value are simply not taken
% into account!

function bf10 = corrbf_onesided(r,n)
%
% bf10 = corrbf(r,n)
%
